		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					...
					<form method="post" action="{{route('beginSignUp')}}">
						@csrf
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Sign Up
						</h4>
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="fullname" placeholder="Your Fullname">
							<img class="how-pos4 pointer-none" src="images/icons/information.png" alt="ICON">
						</div>
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="email" name="email" placeholder="Your Email">
							<img class="how-pos4 pointer-none" src="images/icons/mailicon.png" alt="ICON">
						</div>
