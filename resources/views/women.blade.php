		...
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m m-tb-10">
				...
				@foreach($category as $item)
					...
					<a href="{{route('filterCatWomen', $item->id)}}">
						<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1">
						{{$item->cat_name}}
						</button>
					</a>
				...
				<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
					...
					<div class="filter-col2 p-r-15 p-b-27">
						...
						<ul>
							...
							<li class="p-b-6">
								<a href="{{route('filterBrandWomen', $brand->id)}}" class="filter-link stext-106 trans-04">
									{{$brand->brand_name}}
								</a>
							</li>
							@endforeach
...
<script>
       document.addEventListener("DOMContentLoaded", function () {
        ...
        document.getElementById("buttonRequestSubmit").addEventListener("click", function (event) {
            ...
            const newAction = `/filterProductWomen/${selectedPriceOrder}/${selectedCategory}`;
